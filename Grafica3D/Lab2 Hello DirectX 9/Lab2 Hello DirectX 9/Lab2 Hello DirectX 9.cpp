...
void InitD3D(HWND hWnd)
{
 ...
 // create a device class using this information and information from the d3dpp stuct
    ...
    {
        {SCREEN_WIDTH/2.0,  DELTA_HEIGHT+SCREEN_HEIGHT*0.1, 1.0f, 1.0f, D3DCOLOR_XRGB(0, 0, 255),},
        {SCREEN_WIDTH - DELTA_WIDTH-SCREEN_WIDTH*0.1, SCREEN_HEIGHT*0.8 - DELTA_HEIGHT, 1.0f, 1.0f, D3DCOLOR_XRGB(0, 255, 0),},
        {DELTA_WIDTH+SCREEN_WIDTH*0.1, SCREEN_HEIGHT*0.8 - DELTA_HEIGHT, 1.0f, 1.0f, D3DCOLOR_XRGB(255, 0, 0),},
    };
