...
int main(int argc, char** argv)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (g_rotate)
        {
            ...
            lightPos.z = glm::cos(currentFrame);
        }
...
void renderScene(const Shader& shader)
{
    ...
    // cube 1
    model = glm::mat4();
    model = glm::translate(model, glm::vec3(0.0f, 3.0f, 2.0));
    model = glm::rotate(model, glm::radians(0.8f), glm::vec3(23.0f, 40.0f, 0.0f));
    model = glm::scale(model, glm::vec3(0.75f));
    shader.SetMat4("model", model);
    renderCube();
    // cube 2
    model = glm::mat4();
    model = glm::rotate(model, glm::radians(60.8f), glm::vec3(23.0f, 40.0f, 0.0f));
    model = glm::translate(model, glm::vec3(0.7f, 1.75f, 4.0));
    model = glm::scale(model, glm::vec3(0.75f));
    shader.SetMat4("model", model);
    renderCube();
    // cube 3
    model = glm::mat4();
    model = glm::rotate(model, glm::radians(50.8f), glm::vec3(23.0f, 40.0f, 0.0f));
    model = glm::translate(model, glm::vec3(-4.0f, 3.00f, -1.0));
    model = glm::scale(model, glm::vec3(0.75f));
    shader.SetMat4("model", model);
    renderCube();
    // cube 4
    model = glm::mat4();
    model = glm::rotate(model, glm::radians(20.8f), glm::vec3(23.0f, 40.0f, 0.0f));
    model = glm::translate(model, glm::vec3(-2.0f, 3.8f, -3.0));
    model = glm::scale(model, glm::vec3(0.75f));
    shader.SetMat4("model", model);
    renderCube();
}
